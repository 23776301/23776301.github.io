...
本文档按**主题分章**：性能、部署与流量、音频引擎、可视化、配色、播放控制、UI/交互、数据与存储、调试可观测性、测试验证、性能基准、兼容性、路线图、安全、图标与视觉设计、变更记录。各章相互独立，可按需查阅。
...
14. [十四、安全](#十四安全)
15. [十五、图标系统与视觉设计（Feather 线性图标）](#十五图标系统与视觉设计feather-线性图标)
16. [附录 A：关键参数速查](#附录-a关键参数速查)
17. [附录 B：文件结构与部署清单](#附录-b文件结构与部署清单)
18. [附录 C：版本与变更记录（CHANGELOG）](#附录-c版本与变更记录changelog)
...
# 十五、图标系统与视觉设计（Feather 线性图标）

## 15.1 为什么用内联 SVG 而非 emoji
